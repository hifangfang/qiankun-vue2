...
!function (t, e) {
    ...
    var c = function (e) {
        ...
        var c = this, a = this.dispatch, u = this.commit;
    ...
    function h(t, n, o) {
        ...
        r.config.silent = !0, t._vm = new r({
            data: {$$state: n},
            computed: c
        }), r.config.silent = a, t.strict && function (t) {
    ...
    function p(t, e, n, o, i) {
        var s = !n.length, c = t._modules.getNamespace(n);
        if (o.namespaced && (t._modulesNamespaceMap[c], t._modulesNamespaceMap[c] = o), !s && !i) {
            var a = l(e, n.slice(0, -1)), u = n[n.length - 1];
        ...
        var f = o.context = function (t, e, n) {
            var o = "" === e, i = {
                dispatch: o ? t.dispatch : function (n, o, i) {
                    var r = d(n, o, i), s = r.payload, c = r.options, a = r.type;
        ...
        o.forEachMutation((function (e, n) {
            ...
            var o = e.root ? n : c + n, i = e.handler || e;
            !function (t, e, n, o) {
    ...
    a.state.get = function () {
        ...
        var o = this, i = d(t, e, n), r = i.type, s = i.payload, c = {type: r, payload: s}, a = this._mutations[r];
        ...
        var n = this, o = d(t, e), i = o.type, r = o.payload, s = {type: i, payload: r}, c = this._actions[i];
        if (c) {
            try {
            ...
            var a = c.length > 1 ? Promise.all(c.map((function (t) {
                return t(r)
            }))) : c[0](r);
        ...
        return u(t, this._subscribers, e)
    }, c.prototype.subscribeAction = function (t, e) {
        return u("function" == typeof t ? {before: t} : t, this._actionSubscribers, e)
